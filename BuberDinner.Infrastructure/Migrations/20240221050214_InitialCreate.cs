    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuSections", x => new { x.MenuId, x.MenuSectionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuItems_MenuSections_MenuId_MenuSectionId",
                        columns: x => new { x.MenuId, x.MenuSectionId },
                        principalTable: "MenuSections",
                        principalColumns: new[] { "MenuId", "MenuSectionId" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_MenuId_MenuSectionId",
                table: "MenuItems",
                columns: new[] { "MenuId", "MenuSectionId" });
